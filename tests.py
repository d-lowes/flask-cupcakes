...
class CupcakeViewsTestCase(TestCase):
    ...
    def test_list_cupcakes(self):
        """Test to retrieve all cupcakes from database."""
    ...
    def test_get_cupcake(self):
        """Test to retrieve one cupcake from database."""
        with app.test_client() as client:
    ...
    def test_create_cupcake(self):
        """Testing to create a cupcake to the database."""
        with app.test_client() as client:
            url = "/api/cupcakes"
    ...
    def test_patch_cupcake(self):
        """Testing to update a cupcake in the database."""
        with app.test_client() as client:
            url = f"/api/cupcakes/{self.cupcake_id}"
    ...
    def test_delete_cupcake(self):
        """Testing to delete a cupcake in the database"""
        with app.test_client() as client:
            url = f"/api/cupcakes/{self.cupcake_id}"
